...
- This repository is a working project for tech interview. The assignment is classic microservices challenge - Saving Account Module. To build this within **48 hours**, you must prioritize **velocity and simplicity** over enterprise-grade perfection. You need to cut corners on complexity (like distributed tracing or complex Sagas) while maintaining a clean, working architecture.
