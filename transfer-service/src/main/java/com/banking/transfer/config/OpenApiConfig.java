...
public class OpenApiConfig {
    ...
    public OpenAPI transferServiceOpenAPI() {
        ...
        gatewayServer.setUrl("http://localhost:8080/api/transfer");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("Transfer Orchestration Service for Banking System. " +
                        "Coordinates fund transfer operations between accounts by communicating with Account and Transaction services.")
                .contact(contact)
                .license(license);
