...
public class OpenApiConfig {
    ...
    public OpenAPI registerServiceOpenAPI() {
        ...
        gatewayServer.setUrl("http://localhost:8080/api/register");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("User Registration and Onboarding Service for Banking System. " +
                        "Handles new user account creation and initial setup.")
                .contact(contact)
                .license(license);
